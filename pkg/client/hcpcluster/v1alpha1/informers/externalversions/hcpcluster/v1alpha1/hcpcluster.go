...
import (
	hcpclusterv1alpha1 "Hybrid_Cluster/pkg/apis/hcpcluster/v1alpha1"
	versioned "Hybrid_Cluster/pkg/client/hcpcluster/v1alpha1/clientset/versioned"
	internalinterfaces "Hybrid_Cluster/pkg/client/hcpcluster/v1alpha1/informers/externalversions/internalinterfaces"
	v1alpha1 "Hybrid_Cluster/pkg/client/hcpcluster/v1alpha1/listers/hcpcluster/v1alpha1"
	"context"
	time "time"
