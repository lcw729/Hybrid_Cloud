...
import (
	...
	"github.com/KETI-Hybrid/hcp-metric-collector-c-v1/pkg/clock"
	"github.com/KETI-Hybrid/hcp-metric-collector-c-v1/pkg/decode"
...
func Scrap(config *rest.Config, kubelet_client *kubeletClient.KubeletClient, nodes []corev1.Node) (*storage.Collection, error) {
	...
	for _, node := range nodes {
		...
		go func(node corev1.Node) {
			...
			fmt.Println("print metrics : ", metrics)
			if err != nil {
