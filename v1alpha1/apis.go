...
// import (
// 	"Hybrid_Cluster/pkg/apis"
// 	resourcev1alpha1 "Hybrid_Cluster/pkg/apis/clusterRegister/v1alpha1"
// 	hcppolicyv1alpha1 "Hybrid_Cluster/pkg/client/clientset/hcppolicy/v1alpha1/clientset/versioned/typed/hcppolicy/v1alpha1"
...
// 	HCPPolicy(namespace string) hcppolicyv1alpha1.HCPPolicyInterface
// }
...
// func (c *ExampleV1Alpha1Client) HCPPolicy(namespace string) hcppolicyv1alpha1.HCPPolicyInterface {
// 	return &hcppolicyv1alpha1.HCPPolicyClient{
// 		restClient: c.restClient,
// 		ns:         namespace,
// 	}
// }
