...
func UpdateHCPConfigFile(new_hcp_config util.HCPConfig) error {
	...
	command := &exec.Cmd{
		Path:   "/root/go/src/Hybrid_LCW/Hybrid_Cloud/hybridctl/pkg/hybridctl/sh/parse-config.sh",
		Stdout: os.Stdout,
		Stderr: os.Stderr,
	}
	...
	old_hcp_config, err := LoadHCPConfig("/root/go/src/Hybrid_LCW/Hybrid_Cloud/hybridctl/pkg/hybridctl/tmp.json")
	if err != nil {
		return err
	}
...
func DeleteHCPConfig(section string) error {
	...
	command := &exec.Cmd{
		Path:   "/root/go/src/Hybrid_LCW/Hybrid_Cloud/hybridctl/pkg/hybridctl/sh/delete-config.sh",
		Args:   arguments,
		Stdout: os.Stdout,
		Stderr: os.Stderr,
	}
