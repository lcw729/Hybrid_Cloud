...
import (
	...
	"hcp-metric-collector-client/pkg/customMetrics"
	"hcp-metric-collector-client/pkg/kubeletClient"
	"hcp-metric-collector-client/pkg/protobuf"
	"hcp-metric-collector-client/pkg/scrap"
	"hcp-metric-collector-client/pkg/storage"
