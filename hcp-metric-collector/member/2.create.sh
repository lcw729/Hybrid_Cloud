...
kubectl create ns hcp --context arn:aws:eks:us-east-2:741566967679:cluster/eks-cluster1
...
kubectl create -f deploy/ --context arn:aws:eks:us-east-2:741566967679:cluster/eks-cluster1
...
kubectl create -f deploy/operator/operator-eks-master.yaml --context arn:aws:eks:us-east-2:741566967679:cluster/eks-cluster1
